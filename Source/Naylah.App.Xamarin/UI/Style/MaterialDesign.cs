...
namespace Naylah.App.UI.Style
{
    public class MaterialDesign
    {
        ...
        {
            /// <summary>
            /// The most widely used across all screens and components. In material design palette,
            /// it's the "500" variation. Has some variations in dark and light usages
            /// </summary>
            ...
            /// and interactive elements. Text fields, cursors, text selection, progress bar,
