...
{
    public class CheckBoxRenderer : ViewRenderer<Naylah.Xamarin.Controls.Buttons.CheckBox, CheckBox>
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Naylah.Xamarin.Controls.Buttons.CheckBox> e)
        {
