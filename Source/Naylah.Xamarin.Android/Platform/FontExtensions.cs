...
namespace Xamarin.Forms.Platform.Android
{
    public static class FontExtensions
    {
        ...
        // We don't create and cache a Regex object here because we may not ever need it, and
        // creating Regexes is surprisingly expensive (especially on older hardware) Instead, we'll
        // use the static Regex.IsMatch below, which will create and cache the regex internally as
        // needed. It's the equivalent of Lazy<Regex> with less code. See https://msdn.microsoft.com/en-us/library/sdx2bds0(v=vs.110).aspx#Anchor_2
