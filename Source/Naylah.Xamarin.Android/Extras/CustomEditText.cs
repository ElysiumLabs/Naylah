...
namespace Naylah.Xamarin.Android.Extras
{
    ...
    // protected CustomInputConnectionWrapper(IntPtr javaReference, JniHandleOwnership transfer) :
    // base(javaReference, transfer) { }

    // public override bool SendKeyEvent(KeyEvent e) { try { bool v = base.SendKeyEvent(e); return v;
    // } catch (Exception) { return false; }

    // }

    // public override bool DeleteSurroundingText(int beforeLength, int afterLength) {
    // base.SendKeyEvent(new KeyEvent(KeyEventActions.Down, Keycode.Back)); return false; //return
