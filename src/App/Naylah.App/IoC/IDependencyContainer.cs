...
// T.</param> /// <returns>An instance of <see cref="IDependencyContainer"/></returns>
...
// cref="IDependencyContainer"/></returns> IDependencyContainer Register<T, TImpl>() where T : class
// where TImpl : class, T;
...
// instantiation.</typeparam> /// <returns>An instance of <see
// cref="IDependencyContainer"/></returns> IDependencyContainer RegisterSingle<T, TImpl>() where T :
// class where TImpl : class, T;
...
// instance of <see cref="IDependencyContainer"/></returns> IDependencyContainer Register<T>(Type
// type) where T : class;
